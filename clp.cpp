...
bool CLP::init(const string filename) {
...
void CLP::RemoveLast(double&  o1, double& o2) 
{
        itemsCont.pop_back();
}
...
// Evaluate
// ------------------------------------------------------------------------------
void CLP::evaluateIndividual2 (double&  o1, double& o2) {
